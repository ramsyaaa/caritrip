                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title mb-4">Open Trip {{ count($open_trips) > 0 ? $open_trips[0]->travelPackage->package_name : "" }}</h4>
                            <a href="{{ url('/admin/travel-package/' . $travel_package_id . '/open-trip/create') }}" class="btn btn-success mr-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View" href="{{ url('/admin/travel-package/' . $travel_package_id . '/open-trip/' . $item->id) }}">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/travel-package/' . $travel_package_id . '/open-trip/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'url' => ['/admin/travel-package/' .  $travel_package_id . '/open-trip', $item->id],
