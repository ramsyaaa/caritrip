...
<div class="form-group">
    <img id="image_preview" src="{{ isset($travel_image) && $travel_image->image ? asset( $travel_image->image) : '' }}" alt="Image Preview" style="max-height: 300px; display: {{ isset($travel_image) && $travel_image->image ? 'block' : 'none' }};" />
</div>
