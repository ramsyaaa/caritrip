                        ...
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Title</th><th>Id Category</th><th>Featured Image</th><th>Slug</th><th>Content</th><th>Meta Description</th><th>Meta Keywords</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        <td>{{ $item->title }}</td><td>{{ $item->id_category }}</td><td>{{ $item->featured_image }}</td><td>{{ $item->slug }}</td><td>{{ $item->content }}</td><td>{{ $item->meta_description }}</td><td>{{ $item->meta_keywords }}</td>
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/blog/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
