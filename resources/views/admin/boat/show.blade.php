            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ url('/admin/boat/' . $boat->id . '/images') }}" class="flex items-center justify-center text-white rounded-lg px-3 py-2 text-[14px] bg-[#2C2D84]" style="background-color: #2C2D84;border-radius: 10px">Gambar</a>
                            <a href="{{ url('/admin/boat/' . $boat->id . '/cabins') }}" class="flex items-center justify-center text-white rounded-lg px-3 py-2 text-[14px] bg-[#2C2D84]" style="background-color: #2C2D84;border-radius: 10px">Kabin</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" role="grid">
                                <tbody>
                                    ...
                                    </td></tr><tr><th> Bahasa </th><td> {{ $boat->language ? $boat->language->language_name : '' }} </td></tr><tr><th> Seo Meta Deskripsi </th><td> {{ $boat->seo_meta_description }} </td></tr><tr><th> Seo Meta Keywords </th><td> {{ $boat->seo_meta_keywords }} </td></tr>
                                </tbody>
                            </table>
