...
<div class="form-group{{ $errors->has('boat_length') ? 'has-error' : ''}}">
    {!! Form::label('boat_length', 'Boat Length (meters)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_width') ? 'has-error' : ''}}">
    {!! Form::label('boat_width', 'Boat Width (meters)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_depth') ? 'has-error' : ''}}">
    {!! Form::label('boat_depth', 'Boat Depth (meters)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_speed') ? 'has-error' : ''}}">
    {!! Form::label('boat_speed', 'Boat Speed (knots)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_fuel_capacity') ? 'has-error' : ''}}">
    {!! Form::label('boat_fuel_capacity', 'Boat Fuel Capacity (Liters)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_water_capacity') ? 'has-error' : ''}}">
    {!! Form::label('boat_water_capacity', 'Boat Water Capacity (Liters)', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('boat_capacity') ? 'has-error' : ''}}">
    {!! Form::label('boat_capacity', 'Boat Capacity (pax)', ['class' => 'control-label']) !!}
