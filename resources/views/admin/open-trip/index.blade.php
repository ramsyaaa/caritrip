                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Open Trip {{ count($open_trips) > 0 ? $open_trips[0]->boatTravelPackage->package_name : '' }}</h4>
                            <a href="{{ url('/admin/boat-travel-package/' . $boat_travel_package_id . '/open-trip/create') }}" class="btn btn-success mr-2">
                            ...
                            <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Durasi</th>
                                        <th>Harga</th>
                                        <th>Harga Extra Kasur</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($open_trips as $i => $item)
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/boat-travel-package/' . $boat_travel_package_id . '/open-trip/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'url' => ['/admin/boat-travel-package/' .  $boat_travel_package_id . '/open-trip', $item->id],
