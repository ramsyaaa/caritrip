                        ...
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Language Name</th><th>Language Code</th><th>Is Default</th><th>Is Active</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($language as $i => $item)
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        <td>{{ $item->language_name }}</td><td>{{ $item->language_code }}</td><td>{{ $item->is_default }}</td><td>{{ $item->is_active }}</td>
                                        <td>
