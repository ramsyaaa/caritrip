                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">BoatTravelTrip List</h4>
                            <a href="{{ url('/admin/boat-travel-trip'. '/create') }}" class="btn btn-success mr-2">
                        ...
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Package Id</th><th>Trip Category</th><th>Trip Subcategory</th><th>Trip Name</th><th>Trip Days</th><th>Trip Price</th><th>Trip Note</th><th>Language Id</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        <td>{{ $item->package_id }}</td><td>{{ $item->trip_category }}</td><td>{{ $item->trip_subcategory }}</td><td>{{ $item->trip_name }}</td><td>{{ $item->trip_days }}</td><td>{{ $item->trip_price }}</td><td>{{ $item->trip_note }}</td><td>{{ $item->language_id }}</td>
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/boat-travel-trip/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'url' => ['/admin/boat-travel-trip', $item->id],
