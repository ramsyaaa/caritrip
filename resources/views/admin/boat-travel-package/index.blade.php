                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Paket Kapal</h4>
                        ...
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Nama Paket</th><th>Kapal</th><th>Paket Populer</th><th>Bahasa</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i+1 }}</td>
                                        <td>{{ $item->package_name }}</td><td>{{ $item->boat ? $item->boat->boat_name : '' }}</td><td>{{ $item->is_popular ? 'Yes' : 'No' }}</td><td>{{ $item->language ? $item->language->language_name : '' }}</td>
                                        <td>
