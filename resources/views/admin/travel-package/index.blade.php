                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/travel-package/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'url' => ['/admin/travel-package', $item->id],
