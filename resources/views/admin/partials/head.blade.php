<head>
        ...
        <meta name="DC.title" content="CRM">
        ...
        <!-- Flatpickr css -->
        <link rel="stylesheet" href="{{asset('vendor/dashboard')}}/assets/vendor/flatpickr/dist/flatpickr.min.css">
        ...
        <link href="{{asset('vendor/dashboard')}}/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <!-- SweetAlert2 -->
