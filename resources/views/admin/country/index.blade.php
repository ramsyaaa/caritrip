                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Negara</h4>
                            <a href="{{ url('/admin/countries'. '/create') }}" class="btn btn-success mr-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View" href="{{ url('/admin/countries/' . $item->id) }}">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{ url('/admin/countries/' . $item->id . '/edit') }}">
                                                    <span class="btn-inner">
